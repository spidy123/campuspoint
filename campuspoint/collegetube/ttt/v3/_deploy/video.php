...
if($id==1)
  $qur="select * from video where category='IT'";
if($id==2)
  $qur="select * from video where category='CSE'";
if($id==3)
  $qur="select * from video where category='Mechanical'";
if($id==4)
  $qur="select * from video where category='Civil'";
if($id==5)
  $qur="select * from video where category='Electronics'";
if($id==6)
  $qur="select * from video where category='Electrical'";
if($id==7)
  $qur="select * from video where category='SAIT'";
if($id==8)
  $qur="select * from video where category='ACSES'";
if($id==9)
  $qur="select * from video where category='WLUG'";
if($id==10)
  $qur="select * from video where category='EESA'";
if($id==11)
  $qur="select * from video where category='ELESA'";
if($id==12)
  $qur="select * from video where category='ROTRACT'";
if($id==13)
  $qur="select * from video where category='PACE'";
if($id==14)
  $qur="select * from video where category='MESA'";
if($id==15)
  $qur="select * from video where category='ART_CIRCLE'";
if($id==16)
  $qur="select * from video where category='CESA'";
if($id==17)
  $qur="select * from video where category='SOFTA'";
if($id==-1)
  $qur="select * from video where category='PLACEMENTS'";
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="../../../../departments.php"><span ><i class="glyphicon glyphicon-star"></i> Departments</span></a></li>
        <li><a href="../../../../clubs.php"><span ><i class="glyphicon glyphicon-asterisk"></i> Clubs</span></a></li>
