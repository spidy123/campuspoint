...
$qur1="select * from notes where branch='CSE' and class='FY'";
$res1=mysql_query($qur1,$connection);

$qur2="select * from notes where branch='CSE' and class='SY'";
$res2=mysql_query($qur2,$connection);

$qur3="select * from notes where branch='CSE' and class='TY'";
$res3=mysql_query($qur3,$connection);

$qur4="select * from notes where branch='CSE' and class='BTECH'";
