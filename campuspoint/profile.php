 ...
 <div class="mail-box">
                  <aside class="sm-side">
                      ...
                      <div class="inbox-body">
						  ...
						  <br><br>
						  <a href="#mynotes" data-toggle="modal"  title="Compose"    class="btn btn-compose">
                                              ...
                                              <div class="form-group">
                                                  <div class="col-lg-offset-2 col-lg-10">
													  ...
													  <span class="btn green fileinput-button">
                                                        ...
                                                        <input type="file" name="cover_upload" multiple="">
                                                      </span>
					    ...
					    <form name="form" method="post" action="profile.php">
                         ...
                         <div class="mail-option">
                          ...
                          <table class="table table-inbox table-hover">
							...
							?>
							<?php
							while($data_row_all=mysql_fetch_array($res_count0))
							{
								?>
							
							  
                              <tr class="">
                               <td class="inbox-small-cells"><?php echo $data_row_all['name'];?></td>
                                  <td class="view-message dont-show">Notes</td>
								   <form action="delete_notes.php" method="post" name="myform">
									<td class="view-message"> <button type="submit" class="btn btn-link" name="yes" ><i class="fa fa-trash-o"></button></td>
									<input type="hidden" name="image" value="<?php echo $data_row_all['name']?>"/>
								  </form>
                                  <td class="view-message"><?php echo $data_row_all['date'];?></td>
                                  <td class="view-message"><?php echo $data_row_all['time'];?></td>
