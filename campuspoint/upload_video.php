...
if(isset($_POST['video']))
{
	...
	$dir='collegetube/ttt/v3/_deploy/upload';
	$cat=$_POST['category'];
...
if (in_array($_FILES['file_upload']['type'], $types)) 
{
	...
	{
		mysql_select_db($database,$connection);
		$qur="insert into video(id,username,author_name,video_name,path,category,showname,date,time) values('','$username','$author_name','$video_name','upload/$video_name','$cat','$showname','$date','$time')";
