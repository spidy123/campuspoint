...
$count0="select * from notes where username='".$username."'";
...
$res_count0=mysql_query($count0,$connection);
$temp0=mysql_num_rows($res_count0);
...
$temp_total=$temp0+$temp1+$temp2+$temp3;

$data_qur="select * from notes where username='".$username."'";
...
if(isset($_POST['category']))
{
  $category=$_POST['category'];
   if($category==4)
	  header("Location:profile_notes.php"); 
  if($category==3)
...
if(isset($_POST['search_button']))
{
	...
	$count0="select * from notes where name like '%".$search_key."%' and username='".$username."'";


}

$res_count0=mysql_query($count0,$connection);
$num0=mysql_num_rows($res_count0);
 ...
 <div class="mail-box">
                  <aside class="sm-side">
                      ...
                      <div class="inbox-body">
						  ...
						  <a href="#mygallery" data-toggle="modal"  title="Compose"    class="btn btn-compose">
                          <span class="glyphicon glyphicon-upload"></span> Upload Notes
                          </a>
                          <!-- Modal -->
						  ...
						  <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myaudio" class="modal fade" style="display: none;">
						   ...
						   <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="mynotes" class="modal fade" style="display: none;">
                              <div class="modal-dialog">
                                  <div class="modal-content">
                                      <div class="modal-header">
                                          <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
                                          <h4 class="modal-title">Upload your notes here...</h4>
                                      </div>
                                      <div class="modal-body">
                                          <form role="form" class="form-horizontal" method="post" action="upload_notes.php" enctype="multipart/form-data">
                                              <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                  <label class="col-lg-2 control-label">Notes Name</label>
                                                  <div class="col-lg-10">
                                                      <input type="text" placeholder="" name="notes_name" id="cc" class="form-control">
                                                  </div>
                                              </div>
                      ...
                      <ul class="inbox-nav inbox-divider">
                         ...
                         <li>
                              <a href="profile_notes.php"> <span class="glyphicon glyphicon-edit"></span>&nbsp&nbspNotes<span class="label label-info pull-right"><?php echo $temp0?></span></a>
                          </li>
                      </ul>
					    ...
					    <form name="form" method="post" action="profile_image.php">
                         ...
                         <div class="mail-option">
                          ...
                          <table class="table table-inbox table-hover">
							...
							while($data_row_notes=mysql_fetch_array($res_count0))
							{
								?>
                              ...
                              <tr class="">
                                 ...
                                 <td class="inbox-small-cells"><?php echo $data_row_notes['name'];?></td>
                                  <td class="view-message dont-show"><?php echo $data_row_notes['branch']." ".$data_row_notes['class'];?></td>
								  
								   <form action="delete_notes.php" method="post" name="myform">
									<td class="view-message"> <button type="submit" class="btn btn-link" name="yes" ><i class="fa fa-trash-o"></button></td>
									<input type="hidden" name="image" value="<?php echo $data_row_notes['name']?>"/>
								  </form>
								  
								  
                                  <td class="view-message dont-show"><?php echo $data_row_notes['date'];?></td>

                                  <td class="view-message"><?php echo $data_row_notes['time'];?></td>
						     </tr>
							 <?php
							}
							?>
